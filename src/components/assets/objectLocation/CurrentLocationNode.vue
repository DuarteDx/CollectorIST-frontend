  ...
  export default { 
    ...
    methods: {
        getLocationId() {
            ...
            locationAssetInsertion.setCurrentSelectedLocation(this.rawLocations.containedSpaces[this.selectedLocationId].id)
            assetInsertion.setCurrentIstRoom(locationAssetInsertion.getCurrentSelectedLocation())
